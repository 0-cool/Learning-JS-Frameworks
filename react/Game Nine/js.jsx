...
var ButtonFrame = React.createClass({
	render: function(){
		...
		var disabled = (this.props.redraws === 0);
		return (
				<div id="button-frame"> 
					{button}
					<br/>
					<br/>
					<button disabled={disabled} className="btn btn-warning btn-xs" onClick={this.props.redraw}>
...
var NumbersFrame = React.createClass({
	render: function(){
		...
		for (var i = 1; i <= 9 ; i++) {
			...
			number.push(<div className={className} onClick={selectNumber.bind(null, i)} >
				{i}
				</div>);
		}
		return (
